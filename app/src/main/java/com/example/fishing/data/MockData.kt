    ...
    val sampleReports = listOf(
        FishingReport(
            ...
            fish = listOf(
                ...
                Fish(id = UUID.randomUUID(), name = "Подлещик", count = 2)
            ),
        ...
        FishingReport(
            ...
            weight = 3.5,
            fish = listOf(Fish(id = UUID.randomUUID(), name = "Щука", count = 1)),
        ...
        FishingReport(
            ...
            weight = 1.5,
            fish = listOf(Fish(id = UUID.randomUUID(), name = "Карась", count = 10)),
        ...
        FishingReport(
            ...
            weight = 8.4,
            fish = listOf(Fish(id = UUID.randomUUID(), name = "Сазан", count = 1)),
            fishingMethod = FishingMethod.FEEDER,
        ...
        FishingReport(
            ...
            weight = 5.2,
            fish = listOf(Fish(id = UUID.randomUUID(), name = "Судак", count = 1)),
            fishingMethod = FishingMethod.SPINNING,
        ...
        FishingReport(
            ...
            weight = 4.8,
            fish = listOf(Fish(id = UUID.randomUUID(), name = "Лещ", count = 5), Fish(id = UUID.randomUUID(), name = "Густера", count = 10)),
            fishingMethod = FishingMethod.FEEDER,
        ...
        FishingReport(
            ...
            weight = 12.5,
            fish = listOf(Fish(id = UUID.randomUUID(), name = "Карп", count = 1)),
            fishingMethod = FishingMethod.FEEDER,
            bait = listOf(Bait.CORN),
        ...
        FishingReport(
            ...
            weight = 2.1,
            fish = listOf(Fish(id = UUID.randomUUID(), name = "Плотва", count = 30), Fish(id = UUID.randomUUID(), name = "Окунь", count = 5)),
            fishingMethod = FishingMethod.BOBBER,
